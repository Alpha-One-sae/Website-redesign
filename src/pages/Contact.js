...
export default function Contact() {
  ...
  return (
    <>
      <div className="text-white m-5 overflow-hidden relative z-[0] mb-5">
        <p className="text-5xl font-bold mb-8 text-center" id="pcontact">
          <span className="relative">
            ...
            <span className="relative"><GlowingText>Contact Us!</GlowingText></span>
          </span>
        </p>
        <div className="addrbox grid gap-8 sm:grid-cols-2">
          <div className="gmail relative p-6 border border-blue-500/30 rounded-xl bg-black/50 backdrop-blur-sm hover:border-blue-500 transition-all duration-300">
            ...
            <div className="relative flex flex-col items-center gap-4">
              ...
              <div className="flex flex-col items-center">
                <p className="text-lg font-semibold" id="write">Write Us</p>
                <button
                  id="mail"
          ...
          <div className="gmap relative p-6 border border-blue-500/30 rounded-xl bg-black/50 backdrop-blur-sm hover:border-blue-500 transition-all duration-300">
            ...
            <div className="relative flex flex-col items-center gap-4">
              ...
              <div className="flex flex-col items-center">
                <p className="text-lg font-semibold" id="visit">Visit Us</p>
                <a
                ...
                <p className="text-sm m-3" id="saeloc">University Institute of Engineering and Technology, PU, Chandigarh, India</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div ref={formRef} className={`form-wrapper ${isOpen ? 'open' : 'closed'}`}>
        <div className="gform">
          ...
          <form className="formsae" onSubmit={handleFormSubmit}>
            ...
            <textarea id="msg" rows="6" cols="50" placeholder="Write your message"></textarea>

            <div className="fbtn">
              <button type="submit" className="subbtn">Submit</button>
              <button type="button" className="closef" onClick={toggleForm}>Close</button>
            </div>
          </form>
        </div>
      </div>
